...
export default function DSGVO() {
  return (
    <div className="DSGVO">
      ...
      <p>
        <span id="s3-t-firma">KDesign</span>
        <br />
        <span id="s3-t-ansprechpartner">Konstantin Dauer</span>
        <br />
        <span id="s3-t-strasse">Stahlheimer Straße 4</span>
        <br />
        <span id="s3-t-plz">10439</span> <span id="s3-t-ort">Berlin</span>
      </p>
      <p>
